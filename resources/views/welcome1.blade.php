         ...
         <div class="container-fluid">
            <div class="row d_flex">
               <div class="col-xl-6 col-lg-6 col-md-6 ">
                   <div class="text-bg">
                     <h1>Sitio web para tiendas en linea</h1>
                     <span>Caracterisiticas<br>
                     <br>Gestion de usuarios, Inventario, Catalogo, Filtrado de productos, Pagos en linea</span>
